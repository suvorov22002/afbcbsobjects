...
import com.afriland.cbsobjects.utils.FormatString;
...
public class BkeveBase implements Serializable {
	...
	public String ndos = FormatString.padText("", FormatString.RIGHT, 15, " ");; 			// Numéro de dossier rattaché CHAR 15
	...
	public String desa1 = FormatString.padText("", FormatString.RIGHT, 4, " "); 			// Code désaccord 1 à la saisie CHAR 4 t058Desaccords cacc
	public String desa2 = FormatString.padText("", FormatString.RIGHT, 4, " "); 			// Code désaccord 2 à la saisie CHAR 4 t058Desaccords cacc
	public String desa3 = FormatString.padText("", FormatString.RIGHT, 4, " ");			// Code désaccord 3 à la saisie CHAR 4 t058Desaccords cacc
	public String desa4 = FormatString.padText("", FormatString.RIGHT, 4, " "); 			// Code désaccord 4 à la saisie CHAR 4 t058Desaccords cacc
	public String desa5 = FormatString.padText("", FormatString.RIGHT, 4, " "); // Code désaccord 5 à la saisie CHAR 4 t058Desaccords cacc
	...
	public String desc1 = FormatString.padText("", FormatString.RIGHT, 4, " "); // Code désaccord 1 compte à créditer CHAR 4 t058Desaccords cacc
	public String desc2 = FormatString.padText("", FormatString.RIGHT, 4, " "); // Code désaccord 2 compte à créditer CHAR 4 t058Desaccords cacc
	public String desc3 = FormatString.padText("", FormatString.RIGHT, 4, " "); // 3 compte à créditer CHAR 4 t058Desaccords cacc
	public String desc4 = FormatString.padText("", FormatString.RIGHT, 4, " "); // Code désaccord 4 compte à créditer CHAR 4 t058Desaccords cacc
	public String desc5 = FormatString.padText("", FormatString.RIGHT, 4, " "); // Code désaccord 5 compte à créditer CHAR 4 t058Desaccords cacc
	public String etab = FormatString.padText("", FormatString.RIGHT, 5, " "); // Code établissement bancaire de règlement CHAR 5 bkbqe etab
	public String guib = FormatString.padText("", FormatString.RIGHT, 5, " "); // Code guichet CHAR 5
	public String nome = FormatString.padText("", FormatString.RIGHT, 40, " "); // Nom de l'établissement bancaire CHAR 40
	public String domi = FormatString.padText("", FormatString.RIGHT, 30, " "); // Domiciliation CHAR 30
	public String adb1 = FormatString.padText("", FormatString.RIGHT, 30, " "); // Adresse banque 1 CHAR 30
	public String adb2 = FormatString.padText("", FormatString.RIGHT, 30, " "); // Adresse banque 2 CHAR 30
	public String adb3 = FormatString.padText("", FormatString.RIGHT, 30, " "); // Adresse banque 3 CHAR 30
	public String vilb = FormatString.padText("", FormatString.RIGHT, 30, " "); // Ville banque CHAR 30
	public String cpob = FormatString.padText("", FormatString.RIGHT, 6, " "); // Code postal CHAR 6
	public String cpay = FormatString.padText("", FormatString.RIGHT, 3, " "); // Code pays banque CHAR 3
	public String etabr = FormatString.padText("", FormatString.RIGHT, 5, " "); // Code établissement de règlement CHAR 5
	public String guibr = FormatString.padText("", FormatString.RIGHT, 5, " "); // Code guichet de règlement CHAR 5
	public String comb = FormatString.padText("", FormatString.RIGHT, 25, " "); // Numéro de compte CHAR 25
	public String cleb = FormatString.padText("", FormatString.RIGHT, 2, " "); // Clé RIB CHAR 2
	public String nomb = FormatString.padText("", FormatString.RIGHT, 30, " "); // Nom client autre banque CHAR 30
	public Double mban = 0d; // Montant net banque DECIMAL 19 - 4
	@JsonFormat(pattern="dd-MM-yyyy'T'HH:mm:ss")
	public Date dvab; // Date de valeur banque DATE
	public String cai1 = FormatString.padText("", FormatString.RIGHT, 3, " "); // Numéro de caisse devise nationale CHAR 3 t004Caisses cacc
	public String tyc1 = " "; // Type de caisse à débiter CHAR 1
	public String dcai1 = FormatString.padText("", FormatString.RIGHT, 3, " "); // Code devise caisse à débiter CHAR 3
	...
	public String cai2 = FormatString.padText("", FormatString.RIGHT, 3, " "); // ; //Numéro de caisse autres devises CHAR 3 t004Caisses cacc
	public String tyc2 = " "; // Type de caisse à créditer CHAR 1
	public String dcai2 = FormatString.padText("", FormatString.RIGHT, 3, " "); // Code devise caisse à créditer CHAR 3
	...
	public String nbor = FormatString.padText("", FormatString.RIGHT, 6, " "); // Numéro de bordereau CHAR 6
	...
	public String nato = FormatString.padText("", FormatString.RIGHT, 6, " "); // Nature d'origine CHAR 6
	public String opeo = FormatString.padText("", FormatString.RIGHT, 3, " "); // Code opération d'origine CHAR 3
	public String eveo = FormatString.padText("", FormatString.RIGHT, 6, " "); // Numéro d'évènement d'origine CHAR 6
	public String pieo = FormatString.padText("", FormatString.RIGHT, 11, " "); // Numéro de pièce comptable d'origine CHAR 11
	@JsonFormat(pattern="dd-MM-yyyy'T'HH:mm:ss")
	...
	public String utf = FormatString.padText("", FormatString.RIGHT, 10, " "); // Code utilisateur ayant rappelé pour forcer CHAR 10 evuti cuti
	public String uta = FormatString.padText("", FormatString.RIGHT, 10, " "); // Code utilisateur ayant autorisé CHAR 10 evuti cuti
	...
	public String lib2 = FormatString.padText("", FormatString.RIGHT, 40, " "); // Idem CHAR 40
	public String lib3 = FormatString.padText("", FormatString.RIGHT, 40, " "); // Idem CHAR 40
	public String lib4 = FormatString.padText("", FormatString.RIGHT, 40, " "); // Idem CHAR 40
	public String lib5 = FormatString.padText("", FormatString.RIGHT, 40, " "); // Idem CHAR 40
	public String lib6 = FormatString.padText("", FormatString.RIGHT, 50, " "); // Libellé libre CHAR 50
	public String lib7 = FormatString.padText("", FormatString.RIGHT, 50, " "); // Idem CHAR 50
	public String lib8 = FormatString.padText("", FormatString.RIGHT, 50, " "); // Idem CHAR 50
	public String lib9 = FormatString.padText("", FormatString.RIGHT, 50, " "); // Libellé réservé pour mémorisation du code lettrage CHAR 50
	public String lib10 = FormatString.padText("", FormatString.RIGHT, 50, " "); // Libellé libre CHAR 50
	public String agec = FormatString.padText("", FormatString.RIGHT, 5, " "); // Agence de centralisation pour service étranger CHAR 5 t001Agence cacc
	public String agep = FormatString.padText("", FormatString.RIGHT, 5, " "); // Agence de provenance CHAR 5
	public String intr = "C"; // Code édition livret CHAR 1
	public String orig = "S"; // = "I";
	public String rlet = FormatString.padText("", FormatString.RIGHT, 8, " "); // Référence de lettrage CHAR 8
	...
	public String natp = FormatString.padText("", FormatString.RIGHT, 10, " "); // Nature pièce d'identité CHAR 10
	public String nump = FormatString.padText("", FormatString.RIGHT, 20, " "); // Numéro de pièce d'identité CHAR 20
	public String datp; // Date de délivrance de la pièce d'identité DATE
	public String nomp = FormatString.padText("", FormatString.RIGHT, 36, " "); // Nom du porteur CHAR 36
	public String ad1p = FormatString.padText("", FormatString.RIGHT, 30, " "); // Adresse 1 du porteur CHAR 30
	public String ad2p = FormatString.padText("", FormatString.RIGHT, 30, " "); // Adresse 2 du porteur CHAR 30
	public String delp = FormatString.padText("", FormatString.RIGHT, 30, " "); // Lieu de délivrance de la pièce d'identité porteur CHAR 30
	public String serie = FormatString.padText("", FormatString.RIGHT, 2, " "); // Série de numéro de chèque CHAR 2
	public String nche = FormatString.padText("", FormatString.RIGHT, 14, " "); // Numéro de chèque CHAR 14 bkchq nche
	...
	public String ncff = FormatString.padText("", FormatString.RIGHT, 8, " "); // émis en devise CHAR 8
	public String csa = " "; // Type de chèque (S/A) CHAR 1
	@JsonFormat(pattern="dd-MM-yyyy'T'HH:mm:ss")
	public Date dech; // Date d'échéance DATE
	public String tire = FormatString.padText("", FormatString.RIGHT, 6, " "); // Code tiré autre banque CHAR 6 bktir cod
	...
	public String navl = FormatString.padText("", FormatString.RIGHT, 6, " "); // Numéro d'aval (caution) CHAR 6
	...
	public String moti = FormatString.padText("", FormatString.RIGHT, 4, " "); // Motif de non acceptation CHAR 4
	...
	public String org = FormatString.padText("", FormatString.RIGHT, 5, " "); // Code organisme domiciliateur de prélèvements CHAR 5
	public String cai3 = FormatString.padText("", FormatString.RIGHT, 3, " "); // Numéro de caisse T.C. CHAR 3 t004Caisses cacc
	...
	public String csp2 = FormatString.padText("", FormatString.RIGHT, 10, " "); // Idem CHAR 10
	public String csp3 = FormatString.padText("", FormatString.RIGHT, 10, " "); // Idem CHAR 10
	public String csp4 = FormatString.padText("", FormatString.RIGHT, 10, " "); // Idem CHAR 10
	public String csp5 = FormatString.padText("", FormatString.RIGHT, 10, " "); // Idem CHAR 10
	public String ndom = FormatString.padText("", FormatString.RIGHT, 25, " "); // Numéro de domiciliation (étranger) CHAR 25
	public String cmod = FormatString.padText("", FormatString.RIGHT, 10, " "); // Code motif déclaré CHAR 10
	...
	public String agee = FormatString.padText("", FormatString.RIGHT, 5, " "); // Compte d'encaissement/engagement : agence CHAR 5 bkcom ncp
	public String deve = FormatString.padText("", FormatString.RIGHT, 3, " "); // Compte d'encaissement/engagement : code devise CHAR 3 bkcom dev
	public String ncpe = FormatString.padText("", FormatString.RIGHT, 11, " "); // Compte d'encaissement/engagement : numéro CHAR 11 bkcom ncp
	public String sufe = FormatString.padText("", FormatString.RIGHT, 2, " "); // Compte d'encaissement/engagement : suffixe CHAR 2 bkcom suf
	public String clce = "  "; // : clé de contrôl CHAR 2
	public String ncpi = FormatString.padText("", FormatString.RIGHT, 11, " "); // Numéro de compte d'impayé CHAR 11
	...
	public String ncpp = FormatString.padText("", FormatString.RIGHT, 11, " "); // Numéro de compte de provision CHAR 11
	...
	public String etab1 = FormatString.padText("", FormatString.RIGHT, 5, " "); // Code établissement bancaire 1 CHAR 5 bkbqe etab
	public String guib1 = FormatString.padText("", FormatString.RIGHT, 5, " "); // Code guichet bancaire 1 CHAR 5 bkbqe guib
	public String com1b = FormatString.padText("", FormatString.RIGHT, 15, " "); // Numéro de compte 1 client autre banque CHAR 15
	public String etab2 = FormatString.padText("", FormatString.RIGHT, 5, " "); // Code établissement bancaire 2 CHAR 5 bkbqe etab
	public String guib2 = FormatString.padText("", FormatString.RIGHT, 5, " "); // Code guichet bancaire 2 CHAR 5 bkbqe guib
	public String com2b = FormatString.padText("", FormatString.RIGHT, 15, " "); // Numéro de compte client 2 autre banque CHAR 15
	...
	public String dcai3 = FormatString.padText("", FormatString.RIGHT, 3, " "); // Devise numérique de la caisse CHAR 3 t002DevisesA dev
	...
	public String tope = FormatString.padText("", FormatString.RIGHT, 3, " "); // la télécompensation CHAR 3
	public String img = "N";
	@JsonFormat(pattern="dd-MM-yyyy'T'HH:mm:ss")
	...
	public String paysp = FormatString.padText("", FormatString.RIGHT, 3, " "); // Code pays du remettant et du porteur CHAR 3
	public String pdelp = FormatString.padText("", FormatString.RIGHT, 30, " "); // Pièce délivrée par CHAR 30
	public String manda = "N"; // Mandataire (O/N) CHAR 1
	public String refdos = FormatString.padText("", FormatString.RIGHT, 1, " "); // Référence de la procuration VARCHAR 0 - 20
	...
	public String toString() {
		return "Bkeve [ope=" + ope + ", eve=" + eve + ", age1=" + age1 + ", ncp1=" + ncp1 + ", nom1="
				+ nom1 + ", age2=" + age2 + ", ncp2=" + ncp2 + ", nom2=" + nom2 + "]";
	}
